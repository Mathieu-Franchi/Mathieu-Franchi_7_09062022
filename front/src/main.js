...
import { faCircleXmark, faCircleCheck, faEyeSlash, faEye, faXmark, faCommentDots, faThumbsUp, faTrash, faEllipsis } from '@fortawesome/free-solid-svg-icons' //all solid svg icons
// import { fab } from '@fortawesome/free-brands-svg-icons' //all brand svg icons
/* add icons to the library */
library.add(faCircleXmark, faCircleCheck, faEyeSlash, faEye, faXmark, faCommentDots, faThumbsUp, faTrash, faPenToSquare, faEllipsis);
